...
local function Hide(notify: boolean?)
	...
	if notify then
		if useMobileSizing then
			RayfieldLibrary:Notify({Title = "Interface Hidden", Content = "The interface has been hidden, you can unhide the interface by tapping 'Show patnce.haha'.", Duration = 7})
		else
			RayfieldLibrary:Notify({Title = "Interface Hidden", Content = "The interface has been hidden, you can unhide the interface by tapping K.", Duration = 3})
		end
	end
